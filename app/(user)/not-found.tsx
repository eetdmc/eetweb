...
export default function NotFound() {
  return (
    <section className="pm-noise min-h-[calc(100vh-220px)] flex items-center py-16 md:py-24 xl:py-32">
      <div className="container w-full">
        <div className="error-404-shell mx-auto max-w-[1000px] border border-primary-light/30 bg-white/70 backdrop-blur-[2px] rounded-[28px] p-8 sm:p-12 xl:p-16">
          <span className="error-404-display block xl:hidden">404</span>
          <div className="error-404-kicker mb-6 flex items-center gap-3 sm:gap-4">
          ...
          <div className="error-404-title grid gap-10 xl:grid-cols-[1.25fr_0.75fr] xl:gap-12">
            <div>
              <h1 className="error-404-shimmer text-50 md:text-60 leading-[1] text-forground-two font-[300] max-w-[14ch]">
              ...
              <p className="error-404-copy mt-6 text-19 leading-lhtext-19 font-[300] font-inter text-lggray max-w-[52ch]">
                ...
                journey. You can return to the homepage or browse our services.
              </p>

              <div className="w-full h-px bg-gradient-to-r from-primary-light/15 via-primary-light to-primary-light/15 my-8"></div>

              <div className="error-404-actions flex flex-wrap gap-4">
                <Link
                  href="/"
                  className="group relative inline-flex items-center justify-center rounded-full border border-black px-6 py-3 font-inter text-16 font-[400] text-black overflow-hidden"
                >
                ...
                <Link
                  href="/services"
                  className="group relative inline-flex items-center justify-center rounded-full border border-primary px-6 py-3 font-inter text-16 font-[400] text-primary overflow-hidden"
                >
            ...
            <div className="error-404-meta border-t xl:border-t-0 xl:border-l border-primary-light/40 pt-6 xl:pt-1 xl:pl-8">
              <span className="error-404-display hidden xl:block xl:mb-8">
                404
              </span>
