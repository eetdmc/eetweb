            ...
            <div className="grid grid-cols-2 3xl:grid-cols-[455px_auto]">
              <div className="border-r border-black/20">
                <div className="flex flex-col gap-5 pb-8 xl:pb-[49px] border-b border-black/20" >
                  ...
                  <p className="text-19 leading-[1.526315789473684] font-light text-[#484848] max-w-[36ch] slideInLeft-text">Our world-class service ensures a seamless and unforgettable experience.</p>
                </div>
                <div className="flex flex-col gap-5 pt-10 xl:pt-[51px] pb-20 xl:pb-[130px]">
                  ...
                  <p className="text-19 leading-[1.526315789473684] font-light text-[#484848] max-w-[36ch] slideInLeft-text">Driven by precision, defined by quality—excellence is our standard.</p>
                </div>
              </div>
              <div>
                <div className="flex flex-col gap-5 pl-6 xl:pl-[71.5px] pb-8 xl:pb-[57px] pt-8 xl:pt-[115px] border-b border-black/20">
                  ...
                  <p className="text-19 leading-[1.526315789473684] font-light text-[#484848] max-w-[36ch] slideInLeft-text">Our dedicated team of professional guides is just a call away—day or night.</p>
                </div>
                <div className="flex flex-col gap-5 pl-6 xl:pl-[71.5px] pb-5 xl:pb-[28px] pt-6 xl:pt-[43px] ">
                  ...
                  <p className="text-19 leading-[1.526315789473684] font-light text-[#484848] max-w-[36ch] slideInLeft-text">Connect with the true spirit of the Gulf through curated, local experiences.</p>
                </div>
              </div>
            </div>
          </div>
