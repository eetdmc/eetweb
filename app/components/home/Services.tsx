          ...
          <div className="grid grid-cols-2 xl:grid-cols-3 3xl:grid-cols-[544px_631px_auto]">
            ...
            <div className="pt-6 xl:pt-[41px] border-t border-[#5C8898] mt-25 xl:mt-[180px]">
              <ul>
                {formattedServices.map((service, index) => (
                  ...
                  >
                    <button
                      className={`text-30 leading-[2] font-light text-left transition-all duration-300 ${
                        activeService === index ? "text-black" : ""
                      }`}
            ...
            <div className="pt-6 xl:pt-[41px] border-t border-[#5C8898] mt-25 xl:mt-[180px] pl-15 xl:pl-[106px]">
              <div className="relative">
                ...
                > */}
                <h3
                  className={`text-30 xl:text-50 leading-[1] font-light text-black mb-4 xl:mb-[35px] transition-all duration-300 ease-in-out  ${
                    isTransitioning
                      ? "opacity-0 translate-y-2"
                      : "opacity-100 translate-y-0"
                  }`}
