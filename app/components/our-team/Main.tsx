    ...
    <section className="pb-15 xl:pb-[114px] ">
      ...
      <div className="container">
        <div className="text-center pb-10 xl:pb-[164px]">
            ...
            <h1 className="text-80 leading-[1.25] font-light text-black max-w-6xl mx-auto">Meet the People Behind Your Journey</h1>
        </div>
      </div>
      </div>
      <div className="container pt-10 xl:pt-30 2xl:pt-50 mb-15 xl:mb-30">
