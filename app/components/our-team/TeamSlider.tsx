    ...
    <section className="">
      ...
      <div className="sec-noise relative">
        <div className="container relative">
          <div className="w-full flex justify-between items-center absolute top-20 left-0 z-50">
            <div className="flex gap-[14px] items-center">
              <div className="grid grid-cols-2 w-[29px] gap-[3px] group">
                <div className="w-[13px] h-[13px] bg-lggray hover:bg-primary transition-all duration-300 ease-in-out"></div>
                <div className="w-[13px] h-[13px] bg-lggray hover:bg-primary transition-all duration-300 ease-in-out"></div>
                <div className="w-[13px] h-[13px] bg-lggray hover:bg-primary transition-all duration-300 ease-in-out"></div>
                <div className="w-[13px] h-[13px] bg-lggray hover:bg-primary transition-all duration-300 ease-in-out"></div>
              </div>
              <div><p className="text-base font-light font-inter leading-[1] group-hover:font-bold transition-all duration-300 ease-in-out">Tile View</p></div>
            </div>
