    ...
    <footer>
      <div className="bg-black ">
        <div className="container">
          ...
          <div className="pt-20 lg:pt-[201px] 2xl:pt-[201px] 3xl:pt-[391px]">
            <div className="hidden xl:grid grid-cols-[1fr_1fr_auto] 3xl:grid-cols-[583px_1fr_auto]">
              <div>
                <motion.h3
                  ...
                  transition={{ delay: 0.2, duration: 0.7, ease: "easeOut" }}
                  viewport={{ once: true }}
                  className="text-19 leading-lhtext-19 font-extralight text-white/70 font-inter pb-3 xl:pb-[24px] hidden xl:block"
                >
                  Follow Us
                </motion.h3>
              </div>
              ...
              <div>
                ...
                <p className="text-19 leading-lhtext-19 font-extralight text-white font-inter xl:h-0 opacity-0">
            ...
            <div className="grid grid-cols-2 xl:grid-cols-3 2xl:grid-cols-[1fr_1fr_auto] 3xl:grid-cols-[583px_1fr_auto] gap-y-10 xl:gap-y-0">
              <div>
                <h3 className="text-19 leading-lhtext-19 font-light text-white/70 font-inter pb-3 xl:pb-[24px] xl:hidden underline xl:underline-none underline-offset-8">
                  Follow Us
                </h3>
                <div>
                  <ul>
              ...
              <div>
                ...
                <ul>
                  <motion.li
                    ...
                    whileInView="show"
                    viewport={{ once: true }}
                    className="text-50 leading-[1.34] font-extralight text-white"
                  >
              ...
              <div>
                ...
                <motion.p
                  ...
                  whileInView="show"
                  viewport={{ once: true }}
                  className="text-19 leading-lhtext-19 font-extralight text-white font-inter "
                >
                  East Europe Travel & Tourism LLC
                  <br />
                  PO Box 212371| Suite 12AE02 | iRise Tower
          ...
          <div className="grid grid-cols-2 xl:grid-cols-3 2xl:grid-cols-[1fr_1fr_auto] 3xl:grid-cols-[583px_1fr_auto]">
            <div>
              <motion.h3
                ...
                whileInView="show"
                viewport={{ once: true }}
                className="text-30 leading-[1.03448275862069] font-extralight text-white pb-3 xl:pb-[24px] "
              >
                Destinations
              </motion.h3>
        ...
        <div className="bg-[#191919] py-3 xl:py-[17px] mt-5 xl:mt-[74px]">
          <div className="container">
            <p className="text-14 leading-[1.2] xl:leading-[2.857142857142857] font-light text-white font-inter">
