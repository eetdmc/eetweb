        ...
        <div className="container">
              ...
              <div className="relative flex flex-col h-full justify-center items-center z-20 px-8 xl:px-15 3xl:px-[142px] py-10 md:py-12 xl:py-30 3xl:py-[145px]">
                <div className="flex items-center justify-between flex-wrap sm:flex-nowrap gap-5">
                  <motion.h2 initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: 0.2, duration: 0.7, ease: "easeOut" }} viewport={{ once:true }}
                    className=" max-w-[24ch] text-50 xl:text-60 3xl:text-70 font-light text-white leading-[1.2] 3xl:leading-[1]"
                  >
                  ...
                  <Link href={"/contact-us"} >
                   <motion.button
                    ...
                    viewport={{ once: true }}
                    className="m-auto sm:m-0 group cursor-pointer rounded-full font-inter border border-white min-w-max px-3 sm:px-4 py-1 sm:py-3 xl:px-10 xl:py-5 3xl:px-[65px] 3xl:py-[49.5px] flex items-center gap-1  sm:gap-5 text-base xl:text-[30px] font-light leading-[1.2] text-white transition-colors hover:backdrop-blur-[1px] "
                  >
          ...
          <div className="pt-20 lg:pt-[201px] 2xl:pt-[201px] 3xl:pt-[391px]">
            <div className="hidden xl:grid grid-cols-[1fr_1fr_auto] 3xl:grid-cols-[583px_1fr_auto]">
              <div>
                <motion.h3 initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: 0.2, duration: 0.7, ease: "easeOut" }} viewport={{ once: true }} className="text-19 leading-lhtext-19 font-extralight text-white/70 font-inter pb-3 xl:pb-[24px] hidden xl:block">Follow Us</motion.h3>
              </div>
              <div>
                <motion.h3 initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: 0.4, duration: 0.7, ease: "easeOut" }} viewport={{ once: true }} className="text-19 leading-lhtext-19 font-extralight text-white/70 font-inter pb-3 xl:pb-[24px] hidden xl:block">Contact</motion.h3>
              </div>
              <div>
                <motion.h3 initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: 0.6, duration: 0.7, ease: "easeOut" }} viewport={{ once: true }} className="text-19 leading-lhtext-19 font-extralight text-white/70 font-inter pb-3 xl:pb-[24px] hidden xl:block">Address</motion.h3>
            ...
            <div className="grid grid-cols-2 xl:grid-cols-3 2xl:grid-cols-[1fr_1fr_auto] 3xl:grid-cols-[583px_1fr_auto] gap-y-10 xl:gap-y-0">
              <div>
                ...
                <div>
                  <ul>
                    <motion.li variants={moveUp(0.2)} initial="hidden" whileInView="show" viewport={{ once: true }} className="text-30 leading-lhtext-30 font-extralight text-white">
                      <Link href={"#"}>Instagram</Link>
                    </motion.li>
                    <motion.li variants={moveUp(0.4)} initial="hidden" whileInView="show" viewport={{ once: true }} className="text-30 leading-lhtext-30 font-extralight text-white">
                      <Link href={"#"}>Linkedin</Link>
                    </motion.li>
                    <motion.li variants={moveUp(0.6)} initial="hidden" whileInView="show" viewport={{ once: true }} className="text-30 leading-lhtext-30 font-extralight text-white">
                      <Link href={"#"}>Facebook</Link>
                    </motion.li>
                    <motion.li variants={moveUp(0.8)} initial="hidden" whileInView="show" viewport={{ once: true }} className="text-30 leading-lhtext-30 font-extralight text-white">
                      <Link href={"#"}>X</Link>
                    </motion.li>
                  </ul>
                </div>
              ...
              <div>
                ...
                <ul>
                  <motion.li variants={moveUp(0.2)} initial="hidden" whileInView="show" viewport={{ once: true }} className="text-50 leading-[1.34] font-extralight text-white">
                    <Link href={"tel:+97144229563"}>+971 4 422 9563</Link>
                  </motion.li>
                  <motion.li variants={moveUp(0.4)} initial="hidden" whileInView="show" viewport={{ once: true }} className="text-50 leading-[1.34] font-extralight text-white">
              ...
              <div>
                ...
                <motion.p variants={moveUp(0.2)} initial="hidden" whileInView="show" viewport={{ once: true }} className="text-19 leading-lhtext-19 font-extralight text-white font-inter ">East Europe Travel & Tourism LLC<br />
                  PO Box 212371| Suite 12AE02 | iRise Tower<br />
                  Barsha Heights (Tecom)<br />
                  Dubai, UAE</motion.p>
              </div>
          ...
          <div className="grid grid-cols-2 xl:grid-cols-3 2xl:grid-cols-[1fr_1fr_auto] 3xl:grid-cols-[583px_1fr_auto]">
            <div>
              <motion.h3 variants={moveUp(0.2)} initial="hidden" whileInView="show" viewport={{ once: true }} className="text-30 leading-[1.03448275862069] font-extralight text-white pb-3 xl:pb-[24px] ">Destinations</motion.h3>
              <div>
                <ul>
                  <motion.li variants={moveUp(0.2)} initial="hidden" whileInView="show" viewport={{ once: true }} className="text-19 leading-lhtext-19 font-extralight text-white/70 font-inter hover:text-white transition-colors">
                    <Link href={"/destinations/uae"}>UAE</Link>
                  </motion.li>
                  <motion.li variants={moveUp(0.4)} initial="hidden" whileInView="show" viewport={{ once: true }} className="text-19 leading-lhtext-19 font-extralight text-white/70 font-inter hover:text-white transition-colors">
                    <Link href={"/destinations/oman"}>Oman</Link>
                  </motion.li>
                  <motion.li variants={moveUp(0.6)} initial="hidden" whileInView="show" viewport={{ once: true }} className="text-19 leading-lhtext-19 font-extralight text-white/70 font-inter hover:text-white transition-colors">
                    <Link href={"/destinations/qatar"}>Qatar</Link>
                  </motion.li>
                  <motion.li variants={moveUp(0.8)} initial="hidden" whileInView="show" viewport={{ once: true }} className="text-19 leading-lhtext-19 font-extralight text-white/70 font-inter hover:text-white transition-colors">
            ...
            <div>
              <motion.h3 variants={moveUp(0.2)} initial="hidden" whileInView="show" viewport={{ once: true }} className="text-30 leading-[1.03448275862069] font-extralight text-white pb-3 xl:pb-[24px]">Services</motion.h3>
              <ul>
                <motion.li variants={moveUp(0.2)} initial="hidden" whileInView="show" viewport={{ once: true }} className="text-19 leading-lhtext-19 font-extralight text-white/70 font-inter hover:text-white transition-colors">
