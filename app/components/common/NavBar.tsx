            ...
            {menuItems.map((item, i) => (
              ...
              >
                ...
                {item.submenu && item.submenu.length > 0 ? (
                  <span className="cursor-pointer uppercase font-light w-full h-full leading-[1] text-base text-black group-hover:text-white group-hover:scale-110 transition-all duration-300 ease-in-out">
                    {item.label}
                  </span>
                ) : (
                  <Link
