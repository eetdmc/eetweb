  ...
  return ( 
    <section className="py-10 xl:py-25 2xl:pt-50 2xl:pb-[269px]">
      <div className="container">
          <h2 className="heading text-50 xl:text-70  font-light leading-[1] mb-5 xl:mb-[30px] text-black xl:max-w-[15ch]">Why Choose EET for MICE?</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 why-choose-wrap">
          {
            serviceDetailsData.whyChoose.items.map((item, index) => (
              <div key={index} className="pl-5 xl:pl-6 2xl:pl-[47px] xl:first:border-l border-primary-light xl:min-h-[506px] flex flex-col xl:last:pt-5 group bg-gray-600/10 xl:bg-transparent py-5 xl:py-0 xl:bg-none">
