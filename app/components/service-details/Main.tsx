...
const Main = () => {
  return (
    <section className="pb-15 xl:pb-25 2xl:pb-50 ">
      <div className="pm-noise pt-15 xl:pt-25">
        <div className="container">
          <div className="text-center pb-10 xl:pb-[114px]">
            ...
            <h1 className="text-80 leading-[1.25] font-light text-black max-w-6xl mx-auto">Elevate Your Business Events with EET’s MICE Solutions</h1>
          </div>
        </div>
      </div>
