       ...
       <div className="ml-container-big">
          ...
          <div className="process-grid">
            ...
            <div className="pl-3 xl:pl-30px">
              <motion.h3 variants={moveUp(0.2)} initial="hidden" whileInView="show" viewport={{once: true,amount: "all"}} className="text-20 xl:text-30 leading-[1.466666666666667] font-light text-black mb-4 lg:mb-[25px]">Discovery & Briefing</motion.h3>
            ...
            <div className="pl-3 xl:pl-30px">
              <motion.h3 variants={moveUp(0.2)} initial="hidden" whileInView="show" viewport={{once: true,amount: "all"}} className="text-20 xl:text-30 leading-[1.466666666666667] font-light text-black mb-4 lg:mb-[25px]">On-Site Execution</motion.h3>
            ...
            <div className="pl-3 xl:pl-30px flex flex-col justify-end">
              <motion.h3 variants={moveUp(0.2)} initial="hidden" whileInView="show" viewport={{once: true,amount: "all"}} className="text-20 xl:text-30 leading-[1.466666666666667] font-light text-black mb-4 lg:mb-[25px]">Creative Concept & Planning</motion.h3>
            ...
            <div className="pl-3 xl:pl-30px flex flex-col justify-end">
              <motion.h3 variants={moveUp(0.2)} initial="hidden" whileInView="show" viewport={{once: true,amount: "all"}} className="text-20 xl:text-30 leading-[1.466666666666667] font-light text-black mb-4 lg:mb-[25px]">Post-Event Reporting</motion.h3>
