          ...
          <div className="process-grid flex flex-col md:grid">
            ...
            <div className="md:pl-3 xl:pl-30px sm-csst order1 ">
                          <div className="sm-layout">
                            <div>
                            <motion.h3 variants={moveUp(0.2)} initial="hidden" whileInView="show" viewport={{once: true,amount: "all"}} className="text-[20px] xl:text-30 leading-[1.466666666666667] font-light text-black mb-1 md:mb-4 lg:mb-[25px]">Discovery & Briefing</motion.h3>
            ...
            <div className="md:pl-3 xl:pl-30px sm-csst order3 ">
                        <div className="sm-layout">
                            <div>
                            <motion.h3 variants={moveUp(0.2)} initial="hidden" whileInView="show" viewport={{once: true,amount: "all"}} className="text-[20px] xl:text-30 leading-[1.466666666666667] font-light text-black mb-1 md:mb-4 lg:mb-[25px]">On-Site Execution</motion.h3>
            ...
            <div className="md:pl-3 xl:pl-30px flex flex-col justify-end sm-csst order2">
              <div className="sm-layout">
                            <div>
                            <motion.h3 variants={moveUp(0.2)} initial="hidden" whileInView="show" viewport={{once: true,amount: "all"}} className="text-[20px] xl:text-30 leading-[1.466666666666667] font-light text-black mb-1 md:mb-4 lg:mb-[25px]">Creative Concept & Planning</motion.h3>
            ...
            <div className="md:pl-3 xl:pl-30px flex flex-col justify-end sm-csst order4">
             <div className="sm-layout">
                            <div>
              <motion.h3 variants={moveUp(0.2)} initial="hidden" whileInView="show" viewport={{once: true,amount: "all"}} className="text-[20px] xl:text-30 leading-[1.466666666666667] font-light text-black mb-1 md:mb-4 lg:mb-[25px]">Post-Event Reporting</motion.h3>
