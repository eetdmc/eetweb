          ...
          {awardsData.items.map((item, index) => (
            <div key={index} className="group overflow-hidden hover:overflow-visible bg-gray-500/10 xl:bg-transparent p-2 md:p-4 xl:p-0">
              ...
              <div className="flex flex-col items-center pb-8 lg:pb-10 xl:pb-[66px] group-hover:bg-[#f8f8f8] transition-all duration-300">
                ...
                <h3 className="text-20 xl:text-34 leading-[1.294117647058824] font-light text-center text-black w-fit mx-auto group-hover:mx-0 transition-all duration-300">{item.name}</h3>
              </div>
            </div>
          ))}
        </div>
