...
export default function HomeOfferPopupV2({ onClose }: OfferPopupProps) {
    ...
    return (
        <section className="fixed inset-0 z-[9999] flex items-center justify-center pointer-events-auto">
            ...
            >
                ...
                {/* RIGHT CONTENT */}
                <div className="relative flex-1 px-[clamp(24px,4vw,50px)] py-[clamp(24px,4vw,64px)]">
                    {/* TOP SVG */}
                    ...
                    {/* CONTENT */}
                    <div className="relative z-10 md:pt-[14%] pb-[13%]">
                        ...
                        <p className="text-20 leading-[1.5] font-[300] mb-3 lg:mb-[30px]">
                            {data.description}
                        </p>
                        ...
                        <button
                            ...
                            "
                        >
                            <span className="absolute inset-y-0 left-0 w-0 bg-black transition-all duration-500 ease-in-out group-hover:w-full rounded-full" />
