...
const FeaturesSection = ({ data }: Props) => {
  ...
  return (
    <section
      className="pt-15 xl:pt-[136px] pb-15 xl:pb-[170px] overflow-hidden"
      ref={sectionRef}
    >
        ...
        <div className="grid grid-cols-1 xl:grid-cols-[408px_auto] gap-10 xl:gap-20 3xl:gap-[235px]">
          ...
          >
            <Image
              ...
              width={1000}
              height={1000}
              className="hidden xl:block h-40 w-full xl:h-full object-cover object-bottom xl:object-right max-h-[630px] xl:max-h-none"
            />
            <Image
              src={data.smallImage}
            ...
            <div className="grid grid-cols-2 3xl:grid-cols-[455px_auto]">
              <div className="border-r border-black/20">
                <div className="flex flex-col gap-5 pb-8 xl:pb-[49px] border-b border-black/20 pr-2">
                  ...
                  <h3 className="text-19 leading-[1.526315789473684] text-black font-medium typewriter-text font-sans">
                    {items[0].title}
                  </h3>
                  <p className="text-19 leading-[1.526315789473684] font-light text-black max-w-[36ch] slideInLeft-text font-sans">
                    {items[0].description}
                  </p>
                </div>
                <div className="flex flex-col gap-5 pt-10 xl:pt-[51px] pb-20 xl:pb-[130px] pr-2">
                  ...
                  <h3 className="text-19 leading-[1.466666666666667] text-black font-medium typewriter-text font-sans">
                    {items[1].title}
                  </h3>
                  <p className="text-19 leading-[1.526315789473684] font-light text-black max-w-[36ch] slideInLeft-text font-sans">
                    {items[1].description}
