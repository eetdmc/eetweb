...
const Header = () => {
  ...
  return (
    <header
      className={`w-full py-3 xl:py-7 bg-cover pm-noise transition-all duration-300 max-w-[1920px] mx-auto ${
        isSticky ? "" : "relative"
      }`}
    >
      <div className="container">
        <div className="flex justify-between items-center">
          ...
          <div className="w-[35%] lg:w-[20%] flex gap-2 lg:gap-3 justify-end items-center">
            ...
            <Link
              href="https://online.eet.ae/b2b/?lang=en"
              target="_blank"
              className="flex items-center gap-2 bg-white uppercase rounded-full relative group hover:text-white overflow-hidden lg:pl-5 cursor-pointer"
            >
