      ...
      <div className="pm-noise pt-15 xl:pt-25">
        <div className="container">
          <div className="text-center pb-10 xl:pb-[184px]">
            <h3 className="text-30 leading-lhtext-30 font-light text-black mb-3 xl:mb-[25px]">Partners</h3>
            <h1 className="text-60 xl:text-80 leading-[1.25] font-light text-black max-w-7xl mx-auto">Our Trusted Network of Partners Across the Arabian Gulf</h1>
          </div>
        </div>
      </div>
      <div className="container">
        <div className="text-center border-b border-primary-light py-10 xl:py-25 max-w-[1135px] mx-auto">
