...
export async function GET(request: NextRequest) {
    try {
        ...
        return NextResponse.json({data:mice,message:"Services fetched successfully"}, { status: 200 });
    } catch (error) {
        console.log(error);
...
export async function POST(request: NextRequest) {
    try {
        ...
        return NextResponse.json({data:mice,message:"Service added successfully"}, { status: 200 });
    } catch (error) {
        console.log(error);
        return NextResponse.json({ message: "Internal Server Error" }, { status: 500 });
    }
