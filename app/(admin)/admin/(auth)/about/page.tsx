        ...
        <div className='flex flex-col gap-5'>
            <form className='flex flex-col gap-5' onSubmit={handleSubmit(handleAddAbout)}>
                ...
                <div className='flex flex-col gap-2'>
                        ...
                        <div key={field.id} className='grid grid-cols-2 gap-2 relative border-b pb-2 last:border-b-0'>
                            ...
                            <div className='flex flex-col gap-2'>
                                <div className='flex flex-col gap-2'>
                                    ...
                                    />
                                    {errors.fourthSection?.items?.[index]?.logo && <p className='text-red-500'>{errors.fourthSection?.items?.[index]?.logo.message}</p>}
                                </div>
                                <div className='flex flex-col gap-2'>
                    ...
                    <div className='flex justify-end mt-2'>
                        <Button type='button' addItem onClick={() => fourthSectionAppend({ logo: "", logoAlt: "", title: "", description: "" })}>Add Item</Button>
                    </div>
