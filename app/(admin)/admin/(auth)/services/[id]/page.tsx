  ...
  return (
    <div className="flex flex-col gap-5">
          ...
          <DialogContent className="bg-white">
            ...
            <div className="flex gap-2">
              ...
              <DialogClose
                ...
                onClick={() => handleDeleteService(id as string)}
              >
                Yes
              </DialogClose>
            </div>
      ...
      <form
        ...
        onSubmit={handleSubmit(handleAddMice)}
      >
        <AdminItemContainer>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex flex-col gap-1">
                ...
                <Input
                  ...
                  {...register("firstSection.thirdTitle", {
                    required: "Third Title is required",
                  })}
                />
                {errors.firstSection?.thirdTitle && (
                  <p className="text-red-500">
                    {errors.firstSection?.thirdTitle.message}
                  </p>
                )}
              </div>
              <div>
