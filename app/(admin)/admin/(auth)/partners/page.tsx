...
const PartnerPage = () => {
    ...
    const { register, handleSubmit, setValue, control, formState: { errors } } = useForm<PartnerFormProps>();
    ...
    return (
        <div className='flex flex-col gap-5'>
            <form className='flex flex-col gap-5' onSubmit={handleSubmit(handleAddPartner)}>
